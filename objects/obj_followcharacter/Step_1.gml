...
if xoffsetmax > 0
{
	off_on_y = leader.state == states.ladder or leader.state == states.climbwall 
	or leader.state == states.cheesepepstickside or leader.state == states.comingoutdoor 
	or leader.state == states.door or leader.state == states.Sjump 
	or leader.state == states.Sjumpland or leader.sprite_index == leader.spr_lookdoor 
	or leader.sprite_index == leader.spr_entergate;
	if !off_on_y
