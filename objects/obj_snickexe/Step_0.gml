if !global.snickchallenge && ((global.lap < 99 && !global.classiclap) 
|| (global.lap < 3 && global.classiclap))
{
...
if !hitboxcreate && (!obj_player.instakillmove 
&& obj_player.state != states.handstandjump && obj_player.state != states.punch 
&& obj_player.state != states.mach3 && obj_player.state != states.machslide)
{
	hitboxcreate = true
...
or place_meeting(x, y, obj_shotgunbullet) or place_meeting(x, y, obj_shotgunblast) or place_meeting(x, y, obj_antonball) or ((obj_player.state == states.keyget or obj_player.state == states.victory or obj_player.state == states.gottreasure) && !deactivate)
