if other.object_index == obj_spitcheesespike 
or other.object_index == obj_banditochicken_projectile 
or other.object_index == obj_robotknife
{
	with other.id
	{
...
else if other.object_index == obj_pizzacutter2 && REMIX_GAMEPLAY
{
	with other.ID
		dir = -dir;
}
else if other.object_index == obj_movingoutlet && REMIX_GAMEPLAY
{
	with other.id
	{
