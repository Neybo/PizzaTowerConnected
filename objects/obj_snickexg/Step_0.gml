if !(global.snickrematch && global.snickchallenge) && global.lap < 199
{
...
if !knocked
{
	x = median(x-maxspeed * 0.75,obj_player.x,x+maxspeed * 0.75)
...
if hitboxcreate = false && (obj_player.instakillmove = false 
...
or place_meeting(x, y, obj_shotgunbullet) or place_meeting(x, y, obj_shotgunblast) or place_meeting(x, y, obj_antonball) or ((obj_player.state == states.keyget or obj_player.state == states.victory) && !deactivate)
