...
var drawx = x + (aggr * random_range(-2, 2))
var drawy = y + (1 - yscale) * (50 - 4) + (aggr * random_range(-2, 2));
draw_set_flash(flash);
draw_sprite_ext(sprite_index, image_index, drawx, drawy, 
image_xscale * xscale, image_yscale * yscale, img_angle, image_blend, image_alpha);
