...
if global.showfps
{
	...
	draw_text(950, 530, string(fps));
	
	if check_online()
	{
		draw_text(950, 510, string(global.__socket_ping) + "ms");
		draw_text(950, 490, string(global.__player_count) + " " + onlinetxt);
	}
}

// topping counter
if global.modifier == mods.no_toppings && !instance_exists(obj_choicebase)
&& !(instance_exists(obj_pause) && (obj_pause.pause or obj_pause.pausefad == 2 or obj_pause.pausefad == 4))
{
	...
	var xx = 960 / 2;
	if global.panic && FINAL_GAMEPLAY
		xx += 75;
