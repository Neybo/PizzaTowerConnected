instance_create((bbox_left + ((bbox_right - bbox_left) / 2)), (bbox_top + ((bbox_bottom - bbox_top) / 2)), obj_pumpkinchunks)
...
//    repeat (7)
//        create_debris((bbox_left + ((bbox_right - bbox_left) / 2)), (bbox_top + ((bbox_bottom - bbox_top) / 2)), 3658)
//}
//else
