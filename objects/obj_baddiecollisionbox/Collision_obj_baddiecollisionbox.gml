...
if instance_exists(baddieID) && instance_exists(other.baddieID)
{
	...
	else
	{
		...
		&& !baddieID.invincible && baddieID.instantkillable
		{
		    ...
		    if  (baddieID.object_index != obj_pizzaballOLD or baddieID.object_index != obj_tank) or baddieID.hp <= 0
		    {
				baddieID.hp -= 99
		    ...
		    if (other.baddieID.object_index != obj_tank && other.baddieID.hp <= 0 && other.baddieID.object_index != obj_pizzaballOLD)
		      instance_destroy(other.baddieID)
		}
	}
}
