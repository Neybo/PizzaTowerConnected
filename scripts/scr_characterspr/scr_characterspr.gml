function scr_characterspr(char = character)
{
	char = string(char)
	...
	switch string_upper(char)
	{
		...
		#region PEPPINO
			...
			case "P":
				...
				spr_splat = spr_player_wallsplat
				...
				spr_superjumpside = spr_player_supersidejump
				spr_superjumpsideprep = spr_player_supersidejumpprep
				spr_superjumpsideland = spr_player_supersidejumpland
				...
				spr_haulingland2 = spr_player_haulingland2
				...
				spr_golflook1 = spr_player_golflook1;
				...
				spr_grind = (OLD_GAMEPLAY) ? spr_player_grind : spr_player_grind_NEW
				...
				spr_portalenter = spr_pizzaportalend;
				spr_portalexit = spr_pizzaportalentrancestart;
				
				spr_mach3boostfall = spr_player_machslideboost3fall;
				spr_machboostfall = spr_player_machslideboostfall;
				...
				spr_gnomescene1 = spr_player_gnomecutscene1
				spr_gnomescene2 = spr_player_gnomecutscene2
				spr_gnomescene3 = spr_player_gnomecutscene3
				spr_gnomescene4 = spr_player_gnomecutscene4
				...
				spr_firedrillstart = spr_playerSP_firedrillstart
				spr_firedrill = spr_playerSP_firedrill
				spr_firedrillattack = spr_playerSP_firedrillattack
				
				spr_palette = spr_peppalette
				spr_texture = spr_peptexture // bleh! p-rank bg
		...
		#region NOISE
			...
			case "N":
				...
				spr_backslide = spr_playerN_machroll
				spr_backslideland = spr_playerN_machroll
				...
				spr_haulingland2 = spr_playerN_haulingland
				...
				spr_breakdancestart = spr_playerN_breakdancestart
		...
		#region VIGILANTE
			...
			case "V":
				...
				spr_backslideland = spr_playerV_divekick
				...
				spr_shotgunidle = spr_playerV_shotgunidle
				spr_shotgunshoot = spr_playerV_shotgunshoot
		...
		#region SNICK
			...
			case "S":
				...
				spr_piledriverland = spr_snick_bodyslamland
				...
				spr_portalenter = spr_snick_portalenter;
				spr_portalexit = spr_snick_portalexit;
				...
				spr_texture = spr_snicktexture // bleh! p-rank bg
				break
		...
		#region PIZZELLE
			...
			case "SP":
				...
				spr_hurtwalk = spr_playerSP_move
				...
				spr_haulingland2 = spr_playerSP_haulingland
				...
				spr_breakdancesuper = spr_playerSP_breakdancesuper
				
				spr_poundcancel1 = spr_playerSP_poundcancel1
				spr_poundcancel2 = spr_playerSP_poundcancel2
				
				// new sprites
				if FINAL_GAMEPLAY || global.newpizzy
				{
					...
					spr_machslideboost = spr_playerSP_machslideboost_NEW
				...
				spr_mach3boostfall = spr_player_machslideboost3fall;
				spr_machboostfall = spr_player_machslideboostfall;
				spr_superjumpcancelstart = spr_playerSP_Sjumpcancelstart
				spr_superjumpcancel = spr_playerSP_Sjumpcancel
				
				spr_longjump = spr_playerSP_mach2jump
				spr_longjumpend = spr_playerSP_mach2jump
				...
				if global.newpizzy
				{
					spr_mach1 = spr_playerSP_mach1_NEW2
					spr_mach = spr_playerSP_mach2_NEW2
					spr_mach4 = spr_playerSP_mach4_NEW2
					spr_suplexbump = spr_playerSP_suplexbump_NEW2
					spr_longjump = spr_playerSP_longjump
					spr_longjumpend = spr_playerSP_longjumpend
					if global.newpizzy != 2
						spr_machclimbwall = spr_playerSP_climbwallnew
					if global.newpizzy == 2
					{
						spr_mach1 = spr_playerSP_mach1_EDIT
						spr_mach4 = spr_playerSP_mach4_EDIT
						spr_longjump = spr_playerSP_longjump_EDIT
						spr_longjumpend = spr_playerSP_longjumpend_EDIT
					}
				}
				break;
		...
		#region PIZZANO
			case "SN":
				...
				spr_Ladder = spr_playerSN_ladderidle
				spr_laddermove = spr_playerSN_laddermove
				spr_ladderdown = spr_playerSN_laddermove
				...
				spr_crazyrun = spr_playerSN_mach4
			
				spr_knightpepidle = spr_playerSN_knightidle
				spr_knightpepwalk = spr_playerSN_knightmove
				
				spr_tumble = spr_playerSN_tumble
				spr_crouchslip = spr_playerSN_crouchslip
				spr_crouchslide = spr_playerSN_crouchslide
			
				spr_superjumpprep = spr_playerSN_sjumpprep
				spr_superjump = spr_playerSN_sjump
				spr_superjumppreplight = spr_playerSN_sjumpprep
			
				spr_superjumpsideprep = spr_playerSN_sjumpprepside
				spr_superjumpside = spr_playerSN_sjumpside
				spr_superjumpsideland = spr_player_supersidejumpland
		
				spr_attackdash = spr_playerSN_mach3
				spr_deathend = spr_playerSN_deathend
				
				spr_superjumpsideland = spr_playerSN_sjumpsideland
				spr_hitwall = spr_playerSN_mach3bump
			
				spr_secondjump1 = spr_playerSN_secondjump
				spr_secondjump2 = spr_playerSN_secondjump
			
				spr_walkfront = spr_playerSN_walkfront
				spr_Timesup = spr_playerSN_timesup
		...
		#region PISSINO
			...
			case "PP":
				...
				spr_splat = spr_playerPP_wallsplat
				...
				spr_superjumpcancelstart = spr_playerPP_Sjumpcancelstart
				spr_superjumpcancel = spr_playerPP_Sjumpcancel
				...
				spr_knightpepdoublejump = spr_playerPP_knightdoublejump
				spr_knightpepdownthrust = spr_playerPP_knightdowntrust
				spr_knightpepfly = spr_playerPP_knightfly
			
				spr_mach3boostfall = spr_playerPP_machslideboost3fall
				spr_machboostfall = spr_playerPP_machslideboostfall
				...
				spr_haulingland2 = spr_playerPP_haulingland
				...
				spr_backflip = spr_playerPP_backflip
				...
				spr_breakdancesuper = spr_playerPP_breakdancesuper;
				
				spr_outofpizza1 = spr_playerPP_outofpizza1
				spr_outofpizza2 = spr_playerPP_outofpizza2
				spr_outofpizza3 = spr_playerPP_outofpizza3
				spr_outofpizza4 = spr_playerPP_outofpizza4
				
				spr_levelcomplete = spr_playerPP_levelcomplete
				spr_kungfujump = spr_playerPP_kungfujump
				
				spr_gnomescene1 = spr_playerPP_gnomecutscene1
				spr_gnomescene2 = spr_playerPP_gnomecutscene2
				spr_gnomescene3 = spr_playerPP_gnomecutscene3
				spr_gnomescene4 = spr_playerPP_gnomecutscene4
				...
				spr_rocketslide = spr_playerPP_rocketslide
		...
		/*case "PUFFER":
			...
			case "A":
				...
				spr_jump = spr_playerA_jump;
				spr_fall = spr_playerA_fall;
				spr_mach4 = spr_playerA_clutch;
		...
		case "J":
			...
			spr_crazyrun = spr_playerJ_mach4
			spr_suplexdash = spr_playerJ_suplexdash
			spr_taunt = spr_playerJ_taunt
			spr_mach4 = spr_playerJ_mach3
			spr_climbwall = spr_playerJ_climbwall
			spr_machclimbwall = spr_playerJ_climbwall
