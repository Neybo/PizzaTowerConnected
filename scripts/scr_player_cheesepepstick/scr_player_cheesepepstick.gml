function scr_player_cheesepepstick()
{
	...
	if (key_jump || input_buffer_jump < 8) && (place_meeting(x+1,y,obj_railv) 
	or place_meeting(x-1,y,obj_railv))
	{
	...
	if (key_jump || input_buffer_jump < 8) && place_meeting(x,y-1,obj_railh) 
	{
		scr_soundeffect(sfx_jump)
		grav = basegrav
		vsp = 1
